/* THIS FILE IS AUTO GENERATED by siggen.py -- DO NOT EDIT */
...
namespace cf3 {
namespace common {
template<> void regist_signals_into< cf3::mesh::Mesh >( cf3::mesh::Mesh* c )
{

    c->regist_signal("write_mesh")
        .description("writes the mesh to file")
        .pretty_name("Write Mesh")
        .connect( boost::bind ( signal_write_mesh, c, _1 ) )
        .signature( boost::bind ( signature_write_mesh, c, _1 ) );
